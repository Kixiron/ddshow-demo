...
pub mod typedefs
{
    pub use ::types::StronglyConnected;
    pub use ::types::Edge;
    pub use ::types::Connected;
    pub mod ddlog_std
    {
...
decl_update_deserializer!(UpdateSerializer,(1, types::Edge), (2, types::StronglyConnected));
impl TryFrom<&str> for Relations {
    type Error = ();
    fn try_from(rname: &str) -> ::std::result::Result<Self, ()> {
         match rname {
        "Connected" => Ok(Relations::Connected),
...
impl Relations {
    pub fn type_id(&self) -> ::std::any::TypeId {
        match self {
            Relations::Connected => ::std::any::TypeId::of::<types::Connected>(),
            Relations::Edge => ::std::any::TypeId::of::<types::Edge>(),
            Relations::StronglyConnected => ::std::any::TypeId::of::<types::StronglyConnected>(),
...
impl TryFrom<program::RelId> for Relations {
    ...
    fn try_from(rid: program::RelId) -> ::std::result::Result<Self, ()> {
         match rid {
        0 => Ok(Relations::Connected),
        1 => Ok(Relations::Edge),
        2 => Ok(Relations::StronglyConnected),
        3 => Ok(Relations::__Null),
        4 => Ok(Relations::ddlog_std_Singleton),
             _  => Err(())
         }
    }
}
pub fn relid2name(rid: program::RelId) -> ::std::option::Option<&'static str> {
   match rid {
        0 => ::core::option::Option::Some("Connected"),
        1 => ::core::option::Option::Some("Edge"),
        2 => ::core::option::Option::Some("StronglyConnected"),
        3 => ::core::option::Option::Some("__Null"),
        4 => ::core::option::Option::Some("ddlog_std::Singleton"),
       _  => None
   }
}
#[cfg(feature = "c_api")]
...
pub fn rel_name2orig_name(rname: &str) -> ::std::option::Option<&'static str> {
   match rname {
        "Connected" => ::core::option::Option::Some("Connected"),
...
pub fn rel_name2orig_cname(rname: &str) -> ::std::option::Option<&'static ::std::ffi::CStr> {
   match rname {
        "Connected" => Some(::std::ffi::CStr::from_bytes_with_nul(b"Connected\0") .expect("Unreachable: A null byte was specifically inserted")),
...
pub static RELIDMAP: ::once_cell::sync::Lazy<::fnv::FnvHashMap<Relations, &'static str>> =
    ::once_cell::sync::Lazy::new(|| {
        ...
        map.insert(Relations::Connected, "Connected");
...
pub static RELIDMAPC: ::once_cell::sync::Lazy<::fnv::FnvHashMap<program::RelId, &'static ::std::ffi::CStr>> =
    ::once_cell::sync::Lazy::new(|| {
        let mut map = ::fnv::FnvHashMap::with_capacity_and_hasher(5, ::fnv::FnvBuildHasher::default());
        map.insert(0, ::std::ffi::CStr::from_bytes_with_nul(b"Connected\0").expect("Unreachable: A null byte was specifically inserted"));
        map.insert(1, ::std::ffi::CStr::from_bytes_with_nul(b"Edge\0").expect("Unreachable: A null byte was specifically inserted"));
        map.insert(2, ::std::ffi::CStr::from_bytes_with_nul(b"StronglyConnected\0").expect("Unreachable: A null byte was specifically inserted"));
        map.insert(3, ::std::ffi::CStr::from_bytes_with_nul(b"__Null\0").expect("Unreachable: A null byte was specifically inserted"));
        map.insert(4, ::std::ffi::CStr::from_bytes_with_nul(b"ddlog_std::Singleton\0").expect("Unreachable: A null byte was specifically inserted"));
        map
    });
...
pub fn relval_from_record(relation: Relations, record: &::differential_datalog::record::Record) -> ::std::result::Result<DDValue, ::std::string::String> {
    match relation {
        Relations::Connected => {
            Ok(<types::Connected as ::differential_datalog::record::FromRecord>::from_record(record)?.into_ddvalue())
        },
        Relations::Edge => {
            Ok(<types::Edge as ::differential_datalog::record::FromRecord>::from_record(record)?.into_ddvalue())
        },
        Relations::StronglyConnected => {
            Ok(<types::StronglyConnected as ::differential_datalog::record::FromRecord>::from_record(record)?.into_ddvalue())
        },
        Relations::__Null => {
...
pub fn prog(__update_cb: std::sync::Arc<dyn program::RelationCallback>) -> program::Program {
    let Edge = ::differential_datalog::program::Relation {
        name: ::std::borrow::Cow::from("Edge @ scc.dl:1:1"),
        input: true,
        distinct: false,
        ...
        arrangements: vec![
            types::__Arng_Edge_0.clone(),
        ],
        change_cb: ::core::option::Option::None,
    };
    let Connected = ::differential_datalog::program::Relation {
        name: ::std::borrow::Cow::from("Connected @ scc.dl:3:1"),
        input: false,
        distinct: false,
        caching_mode: ::differential_datalog::program::CachingMode::Set,
        key_func: ::core::option::Option::None,
        id: 0,
        rules: vec![
            types::__Rule_Connected_0.clone(),
            types::__Rule_Connected_1.clone(),
        ],
        arrangements: vec![
            types::__Arng_Connected_0.clone(),
            types::__Arng_Connected_1.clone(),
            types::__Arng_Connected_2.clone(),
        ],
        change_cb: ::core::option::Option::None,
    };
    let StronglyConnected = ::differential_datalog::program::Relation {
        name: ::std::borrow::Cow::from("StronglyConnected @ scc.dl:7:1"),
        input: false,
        distinct: true,
        caching_mode: ::differential_datalog::program::CachingMode::Set,
        key_func: ::core::option::Option::None,
        id: 2,
        rules: vec![
            types::__Rule_StronglyConnected_0.clone(),
        ],
        arrangements: vec![
        ],
    ...
    let nodes: std::vec::Vec<program::ProgNode> = vec![
            ...
            program::ProgNode::Scc{rels: vec![program::RecursiveRelation{rel: Connected, distinct: true}]},
